...
import 'package:tripkuy/model/tempat_pariwisata.dart';
...
class _HomeView extends State<HomeView> {
  List<TempatPariwisata> _tempatpariwisata = <TempatPariwisata>[];
  @override
  void initState() {
    super.initState();
    _loadTempatPariwisata();
  }

  void _loadTempatPariwisata() async {
    final webservice = Webservice();
    final results = await webservice.loadTempatPariwisata();
    setState(() {
      _tempatpariwisata = results;
    });
  }
  ...
  Widget destination() {
    return ListView.builder(
      ...
      itemCount: _tempatpariwisata.length,
      shrinkWrap: true,
          ...
          child: Stack(
            children: [
              ClipRRect(
                  ...
                  child: Image.asset(
                    Constant.listDestination[0].image!,
                    height: 250,
                    width: 180,
                    fit: BoxFit.cover,
                  )),
              Positioned(
                  ...
                  child: Column(
                    ...
                    children: [
                      Component.textBold(_tempatpariwisata[index].nama_tempat,
                          fontSize: 12, colors: ColorPalette.white),
                      const SizedBox(
                        height: 10,
                      ),
                      Row(
                        ...
                        children: [
                          ...
                          Component.textBold(_tempatpariwisata[index].lokasi,
                              fontSize: 12, colors: ColorPalette.white),
                        ],
                      )
                    ],
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Component.textBold("5.0",
                          fontSize: 12, colors: ColorPalette.grey),
                    ],
                  ),
                ],
              )
  ...
  Widget buildListViewHeader(List<String> listCategory, int indexCategory) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) =>
          buildPaddingHeaderCard(listCategory[index], index, indexCategory),
    );
  }
  ...
  Padding buildPaddingHeaderCard(String all, int index, int indexCategory) {
    return Padding(
      ...
      child: FlatButton(
        ...
        onPressed: () {},
        child: Component.textDefault(all,
            colors:
                indexCategory == index ? ColorPalette.white : ColorPalette.grey,
            fontSize: 12),
      ),
    );
  }
